        ...
        >
          ...
          <g id="catRun">
            ...
            <g id="cat">
              ...
              <g id="headObject">
                ...
                <g id="mouthObject">
                  ...
                  <g id="mouthTe&#208;&#181;thsShadow">
                    ...
                    >
                      <path
                        id="mouthTe&#208;&#181;thsMask"
                        d="M170.729 187.5C151.729 189 133.729 182.5 131.229 184C131.229 184 130.229 190.5 132.229 193.5C134.229 196.5 154.729 198.5 164.229 198.5C173.729 198.5 206.193 196.5 206.193 196.5C206.274 191.127 205.524 185.399 204.054 179.5C204.054 179.5 189.729 186 170.729 187.5Z"
                        fill="white"
                      />
                    </mask>
                    <g mask="url(#mask0)">
                      <g
                        id="mouthTe&#208;&#181;thsShadowForm"
                        filter="url(#filter0_if)"
                      >
                        <path
                          d="M170.729 187.5C151.729 189 133.729 182.5 131.229 184C131.229 184 130.989 185.558 130.979 187.5C130.979 187.5 145.229 192.5 170.229 192C195.229 191.5 205.041 184 205.041 184C204.76 182.513 204.431 181.012 204.054 179.5C204.054 179.5 189.729 186 170.729 187.5Z"
                          fill="#EAEAEA"
                        />
                      </g>
                    </g>
                ...
                <path
                  d="M27.229 202.5C40.229 240.5 99.729 244 109.729 244C115.494 244 145.229 245 169.229 236.048C169.229 236.048 155.729 238.5 146.729 236.048C146.729 236.048 114.729 238.952 90.7289 235.5C66.7289 232.048 40.8905 222.228 29.7289 200.5C25.0915 191.472 26.629 174 26.629 174C24.3646 184.292 24.3672 194.135 27.229 202.5Z"
                  fill="#EAEAEA"
                />
                <path
                ...
                <g id="headSparkleObject">
                  <path
                    d="M124.229 198C123.229 207.5 124.729 215 128.229 221C131.729 227 137.729 233.596 146.729 236.048C155.729 238.5 169.229 236.048 169.229 236.048C144.729 245 115.494 244 109.729 244C105.547 244 92.7055 243.388 78.229 239.895C78.229 239.895 74.229 228.5 76.729 217.5C79.229 206.5 89.729 197.5 102.729 194.5C115.729 191.5 124.761 194.5 124.761 194.5C124.544 195.557 124.364 196.719 124.229 198Z"
                    fill="#FFDADA"
                  />
                  <path
                    d="M109.729 244C115.494 244 145.229 245 169.229 236.048C169.229 236.048 155.729 238.5 146.729 236.048C146.729 236.048 114.729 238.952 90.729 235.5C86.0245 234.823 81.2493 233.902 76.5278 232.694C76.5278 232.694 76.8978 235.029 77.249 236.5C77.5674 237.834 78.209 239.878 78.209 239.878C92.7155 243.386 105.54 244 109.729 244Z"
                    fill="#F3C3C3"
                  />
                </g>
                <g id="tongueObject">
                  <path
                    d="M159.229 263C151.229 267.5 142.229 269 134.229 266C126.229 263 125.729 255 127.729 248.5C129.729 242 138.229 236.5 139.229 233C140.229 229.5 120.229 235 120.229 235L112.229 207.5C112.229 207.5 133.229 201.5 149.229 207.5C165.229 213.5 173.729 221.5 174.729 235C175.729 248.5 167.229 258.5 159.229 263Z"
                    fill="#FF5A45"
                  />
                  <path
                    d="M159.229 263C151.229 267.5 142.229 269 134.229 266C126.229 263 125.729 255 127.729 248.5C127.729 248.5 126.729 256 132.229 261C137.729 266 153.229 265 164.229 256.5C175.229 248 174.729 235 174.729 235C175.729 248.5 167.229 258.5 159.229 263Z"
                    fill="#DE3E22"
                  />
                  <path
                    d="M165.729 229C165.729 229 165.729 225.5 164.729 221.5C163.729 217.5 161.944 213.759 161.944 213.759C163.315 214.674 164.577 215.634 165.729 216.645C165.729 216.645 166.729 218.5 166.729 221.5C166.729 224.5 165.729 229 165.729 229Z"
                    fill="#DE3E22"
                  />
                  <path
                    d="M120.229 235L112.229 207.5C112.229 207.5 127.017 203.275 141.229 205.461C141.229 205.461 129.229 207 129.729 215.5C130.229 224 147.229 226.5 144.229 231.5C141.229 236.5 135.897 237.5 135.897 237.5C137.543 235.773 138.87 234.257 139.229 233C140.229 229.5 120.229 235 120.229 235Z"
                    fill="#DE3E22"
                  />
                </g>
                <path
                  d="M124.229 198C123.229 207.5 124.729 215 128.229 221C130.445 224.799 133.663 228.837 138.011 231.91L130.229 236.5H111.229L76.314 231.278C75.7883 227.283 75.626 222.353 76.729 217.5C79.229 206.5 89.729 197.5 102.729 194.5C115.729 191.5 124.761 194.5 124.761 194.5C124.544 195.557 124.364 196.719 124.229 198Z"
                  fill="#FFDADA"
                />
              </g>
            </g>
            <g id="coinGroup">
              ...
              <g id="coinWaves">
                <path
                  id="coinWave_1"
                  d="M242.229 280.5C242.229 270.172 247.638 265.5 247.638 265.5C247.638 265.5 245.229 272.139 245.229 280.5C245.229 288.861 248.729 295.5 248.729 295.5C248.729 295.5 242.229 290.828 242.229 280.5Z"
                  fill="#FFC20D"
                />
                <path
                  id="coinWave_2"
                  d="M234.229 280.5C234.229 274.45 236.729 272.5 236.729 272.5C236.729 272.5 235.429 275 235.429 280.5C235.429 286 236.729 288.5 236.729 288.5C236.729 288.5 234.229 286.55 234.229 280.5Z"
                  fill="#FFC20D"
                />
                <path
                  id="coinWave_3"
                  d="M227.229 280.5C227.229 277.5 228.729 276.5 228.729 276.5C228.729 276.5 228.029 278.934 228.029 280.5C228.029 282.066 228.729 284.5 228.729 284.5C228.729 284.5 227.229 283.5 227.229 280.5Z"
                  fill="#FFC20D"
                />
              </g>
            </g>
          ...
          <defs>
            ...
            >
              ...
              <feColorMatrix
                type="matrix"
                values="0 0 0 0 0.870588 0 0 0 0 0.870588 0 0 0 0 0.870588 0 0 0 1 0"
              />
